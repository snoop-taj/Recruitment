...
if ($this->action == 'admin_edit') {
	$this->Html->addCrumb($this->data['Category']['name'], $this->here);
	$this->viewVars['title_for_layout'] = 'Categories: ' . $this->data['Category']['name'];
} else {
...
<div class="categories row-fluid">
	<div class="span8">
		...
		<?php
			echo $this->Croogo->adminTab(__d('croogo', 'Category'), '#category');
